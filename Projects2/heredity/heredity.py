...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        trait = PROBS["trait"][genes][True] if person in have_trait else PROBS["trait"][genes][False]
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        probabilities[person]["gene"] = {gene: prob / total_gene for gene, prob in probabilities[person]["gene"].items()}
